...
@Slf4j
@Service
public class MusServiceImpl implements MusService{

    @Value("${studio.mus.prefix}")
    private String studioPrefix;

    @Value("${studio.mus.name}")
    private String englishName;

    @Value("${studio.mus.japaneseName}")
    private String japaneseName;

    @Value("${studio.mus.uri}")
    private String pondoUri;

    @Value("${studio.mus.movieDetails}")
    private String movieDetailsApi;

    @Value("${studio.mus.movieGallery}")
    private String movieGalleryApi;

    @Value("${studio.mus.movieGalleries}")
    ...
    @Override
    public List<MovieNfo> createMus(List<String> codes  ){
        return codes.stream()
                .map(this::createMus)
    ...
    @Override
    public MovieNfo createMus(String code){
